...
hold on, plot(datenum(All_data.time_UTC),-1.*All_data.tdoa,'m.')
...
colors = 'rgbcmyk';
hold on, gscatter(datenum(Annotated_data.time_UTC),-1.*Annotated_data.tdoa, Annotated_data.annotatedID,colors,'ods<p>',6);
xlim([t_serialdate(1),t_serialdate(end)])
